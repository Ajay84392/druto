...
<div class="flex-1 overflow-auto p-4 md:p-10">
    <div class="mb-8">
        <h1 class="text-2xl font-bold text-[#0f172a] mb-1">My Profile</h1>
        <div class="text-xs text-[#475569] font-medium flex items-center space-x-1">
            <a href="/customer" class="hover:text-[#b00000] transition">Home</a>
    ...
    <div class="bg-white rounded-[2rem] shadow-sm border border-slate-100 max-w-md mx-auto mt-6">
        ...
        <div class="p-6 md:p-8 space-y-6">
            ...
            <div class="flex items-center space-x-4 text-[13px] font-semibold text-slate-700">
                ...
                <span>{{ auth()->user()->phone ?? '+91 98765 43210' }}</span>
            </div>
        ...
        <div class="p-4 md:p-6 pb-6 md:pb-8">
            <a href="{{ route('customer.logout') }}" class="w-full flex items-center justify-between p-3 rounded-xl hover:bg-red-50 transition text-[13px] font-bold text-[#b00000] group">
                <div class="flex items-center space-x-4">
